...
struct UpperLowerCalculator {
    ...
    private static let benchSessions: [[BenchSet]] = [
        [.init(percent: .80, reps: "6", type: "обычный"), .init(percent: .825, reps: "5", type: "обычный"), .init(percent: .825, reps: "5", type: "обычный"), .init(percent: .85, reps: "4", type: "обычный"), .init(percent: .85, reps: "4", type: "обычный")],
        [.init(percent: .85, reps: "3", type: "обычный"), .init(percent: .85, reps: "3", type: "обычный"), .init(percent: .925, reps: "2", type: "обычный"), .init(percent: .925, reps: "2", type: "обычный"), .init(percent: 1.025, reps: "1", type: "негатив")],
        [.init(percent: .80, reps: "6", type: "обычный"), .init(percent: .85, reps: "5", type: "обычный"), .init(percent: .85, reps: "5", type: "обычный"), .init(percent: .875, reps: "4", type: "обычный"), .init(percent: .875, reps: "4", type: "обычный")],
        [.init(percent: .875, reps: "3", type: "обычный"), .init(percent: .875, reps: "3", type: "обычный"), .init(percent: .95, reps: "2", type: "обычный"), .init(percent: .95, reps: "2", type: "обычный"), .init(percent: 1.05, reps: "1", type: "негатив")],
        [.init(percent: .80, reps: "6", type: "обычный"), .init(percent: .85, reps: "5", type: "обычный"), .init(percent: .85, reps: "5", type: "обычный"), .init(percent: .90, reps: "макс.", type: "тест")],
        [.init(percent: .90, reps: "3", type: "обычный"), .init(percent: .90, reps: "3", type: "обычный"), .init(percent: .95, reps: "2", type: "обычный"), .init(percent: .95, reps: "2", type: "обычный"), .init(percent: 1.05, reps: "1", type: "негатив")],
        [.init(percent: .85, reps: "5", type: "обычный"), .init(percent: .85, reps: "5", type: "обычный"), .init(percent: .90, reps: "3", type: "обычный"), .init(percent: .90, reps: "3", type: "обычный"), .init(percent: .925, reps: "макс.", type: "тест")],
        [.init(percent: .925, reps: "3", type: "обычный"), .init(percent: .925, reps: "3", type: "обычный"), .init(percent: 1.0, reps: "1", type: "обычный"), .init(percent: 1.0, reps: "1", type: "обычный"), .init(percent: 1.10, reps: "1", type: "негатив")],
        [.init(percent: .85, reps: "5", type: "обычный"), .init(percent: .85, reps: "5", type: "обычный"), .init(percent: .95, reps: "3", type: "обычный"), .init(percent: .95, reps: "3", type: "обычный"), .init(percent: .95, reps: "макс.", type: "тест")],
        [.init(percent: .95, reps: "3", type: "обычный"), .init(percent: .95, reps: "3", type: "обычный"), .init(percent: 1.025, reps: "2", type: "обычный"), .init(percent: 1.025, reps: "2", type: "обычный"), .init(percent: 1.05, reps: "1", type: "обычный")],
        [.init(percent: .875, reps: "5", type: "обычный"), .init(percent: .875, reps: "5", type: "обычный"), .init(percent: .95, reps: "3", type: "обычный"), .init(percent: .95, reps: "3", type: "обычный"), .init(percent: .95, reps: "макс.", type: "тест")],
        [.init(percent: .95, reps: "3", type: "обычный"), .init(percent: .95, reps: "3", type: "обычный"), .init(percent: 1.025, reps: "2", type: "обычный"), .init(percent: 1.025, reps: "2", type: "обычный"), .init(percent: 1.05, reps: "1", type: "обычный")],
        [.init(percent: .90, reps: "5", type: "обычный"), .init(percent: 1.0, reps: "3", type: "обычный"), .init(percent: 1.0, reps: "3", type: "обычный"), .init(percent: 1.05, reps: "2", type: "обычный"), .init(percent: 1.05, reps: "2", type: "обычный")],
        [.init(percent: .95, reps: "3", type: "обычный"), .init(percent: 1.05, reps: "2", type: "обычный"), .init(percent: 1.075, reps: "1", type: "рекорд")]
    ]
}
